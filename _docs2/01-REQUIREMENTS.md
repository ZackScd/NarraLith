...
Documento de planificación **vigente**. Resume la visión del proyecto original (`_docs/01-REQUIREMENTS.md`) y corrige lo que cambió en implementación — sobre todo **manuscrito**, **calendario** y **tiempo**.
