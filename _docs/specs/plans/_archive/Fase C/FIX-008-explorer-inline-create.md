...
> **Ruta canónica:** `plans/_archive/Fase C/FIX-008-explorer-inline-create.md` (copias sueltas en `plans/*.md` obsoletas)  
...
| 2026-06-11 | Plan movido a `plans/_archive/Fase C/`; enlaces canónicos actualizados |
