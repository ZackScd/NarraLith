...
> **Lista maestra:** [`implementation-plan.md`](../../implementation-plan.md) Fase E · **Spec:** [`04-TASK.md`](../../../archive/retired-cadence/04-TASK.md) § II.4.1 · [`manuscript-roadmap.md`](../../manuscript-roadmap.md) M7
...
| Pregunta | Respuesta |
|----------|-----------|
| ¿Existía plan en `plans/_archive/Fase E/` **antes** de codificar? | **No.** La carpeta estaba vacía. |
| ¿Qué autorizó el trabajo? | [`manuscript-roadmap.md`](../../manuscript-roadmap.md) M7 + [`04-TASK.md`](../../../archive/retired-cadence/04-TASK.md) § II.4.1 + acuerdo en chat (jun 2026). |
...
**Regla recuperada:** plan detallado en `plans/_archive/Fase E/` → implementación → QA NDJSON → cierre en este archivo.
