...
| **6 — Documentación** | ✅ | § Observabilidad en [`06-ARCHITECTURE.md`](../../archive/retired-cadence/06-ARCHITECTURE.md); este plan cerrado |
...
| [`src-tauri/.taurignore`](../../../src-tauri/.taurignore) | Excluye `_docs/` del bundle | `_debug/` no entra al binario (está en repo root, no en resources) |
...
- [x] [`06-ARCHITECTURE.md`](../../archive/retired-cadence/06-ARCHITECTURE.md): sección Observabilidad.
...
| Acciones usuario (OBS-003) | [`plans/_archive/Fase D/OBS-003-action-audit-log.md`](../Fase%20D/OBS-003-action-audit-log.md) |
| Estado UI (OBS-002) | [`plans/_archive/Fase C/OBS-002-ui-render-audit-log.md`](../Fase%20C/OBS-002-ui-render-audit-log.md) |
