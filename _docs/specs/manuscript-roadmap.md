...
**Siguiente (código):** Era III / MAP — **después** de ordenar documentación `_docs/`.
...
> Tarea detallada: [`../archive/retired-cadence/04-TASK.md`](../archive/retired-cadence/04-TASK.md) § II.4.1 · **Plan:** [`plans/_archive/Fase E/ERAII-001-single-model-manuscript.md`](../plans/_archive/Fase%20E/ERAII-001-single-model-manuscript.md) · Cerrado 2026-06-11 · commit `a5c06f6`
...
> **Política (jun 2026):** no bloqueó cierre v0.10.0. Ejecutar cuando convenga antes de MAP o en paralelo.  
> **Índice cruzado:** [`plans/_archive/DEFERRED.md`](plans/_archive/DEFERRED.md) §2.
...
> Cerrado 2026-06-11 · **Plan:** [`plans/_archive/Fase E/ERAII-002-qa-manual-section7.md`](plans/_archive/Fase%20E/ERAII-002-qa-manual-section7.md)  
> **Criterio:** smoke QA (`5608`/`22856` + histórico M7/FIX); checklist §7 completa → § Afinado final.

Changelog: [`../05-CHANGELOG.md`](archive/retired-cadence/05-CHANGELOG.md) v0.10.0 · Era II ✅ [`../03-ROADMAP.md`](../03-ROADMAP.md)
