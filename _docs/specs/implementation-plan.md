...
| **MAP-001** | ⬜ | Modelo de datos y persistencia en disco + **purga física legacy** | Alto | [`maps-design.md`](maps-design.md) §9 · [`maps-roadmap.md`](maps-roadmap.md) |
...
| 2026-06-11 | **MAP-000 ✅** decisiones Era III mapas + inventario purga — [`plans/Fase F/MAP-000-inventory-purge.md`](plans/Fase%20F/MAP-000-inventory-purge.md) · [`maps-roadmap.md`](maps-roadmap.md) · spec §9 |
