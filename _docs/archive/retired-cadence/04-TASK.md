...
> **Directrices:** `_docs/07-GUIDELINES-LLMs.md` (pendiente copia a `_docs/`).  
...
1. **Documentación:** establecer `_docs/` como fuente de verdad (esta cadena 03→04→05).
2. **Código (siguiente):** estabilizar editor manuscrito — fases II.4–II.5 del spec.

---

### Tarea II.0.1 — Cadena documental `_docs/`
...
- [x] Nota de deprecación en `_docs/README.md` → apunta a `_docs/`

#### Criterio de salida

README de `_docs/` enlaza toda la cadena; no hay dos roadmaps “vivos”.
...
Ninguna importación activa de `ParsedDocument` en flujo manuscrito (salvo tests si aplica). **Cumplido** (2026-06-11). Plan retroactivo: [`specs/plans/_archive/Fase E/ERAII-001-single-model-manuscript.md`](specs/plans/Fase%20E/ERAII-001-single-model-manuscript.md).
...
> **Plan de ejecución:** [`specs/plans/_archive/Fase E/ERAII-002-qa-manual-section7.md`](specs/plans/Fase%20E/ERAII-002-qa-manual-section7.md) — matriz **S7-01…S7-13** + QA residual FIX-004/005/012/013.
...
| Tarea | Estado | Notas |
|-------|--------|-------|
| II.0.1 Cadena `_docs/` | ✅ | 2026-06-06 |
