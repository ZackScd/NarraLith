...
Entre **v0.9.0** y el inicio de `_docs/`, el desarrollo continuó sin actualizar `04-TASK.md` ni `05-CHANGELOG.md` en `_docs/`. Trabajo relevante en ese período (resumen, no exhaustivo):
