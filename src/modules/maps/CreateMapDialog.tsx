...
import type { MapAspectPreset, MapCreateDraft, MapSizePresetId } from "@/lib/types/maps";
import {
...
export function CreateMapDialog({
  ...
  const handleSubmit = async (event: React.FormEvent) => {
    ...
    if (!isDimensionInRange(width) || !isDimensionInRange(height)) {
          ...
          <div className="mt-4 space-y-4">
            ...
            <div className="space-y-1.5">
              ...
              <select
                ...
                value={sizePreset}
                onChange={(e) => applySizePreset(e.target.value as MapSizePresetId)}
              >
            ...
            <div className="space-y-1.5">
              ...
              <select
                ...
                className={SELECT_CLASS}
                value={aspectPreset}
                onChange={(e) => handleAspectChange(e.target.value as MapAspectPreset)}
              >
