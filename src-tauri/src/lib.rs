...
pub fn run() {
    ...
    builder
        .invoke_handler(tauri::generate_handler![
            ...
            commands::maps::get_map_document_cmd,
            commands::maps::save_map_document_cmd,
            ...
            commands::maps::record_map_viewed_cmd,
            commands::maps::list_map_secondaries_cmd,
            commands::maps::get_map_secondary_cmd,
            commands::maps::create_map_secondary_cmd,
            commands::maps::save_map_secondary_cmd,
            commands::maps::update_map_secondary_meta_cmd,
            commands::maps::delete_map_secondary_cmd,
            commands::maps::list_map_nav_cmd,
            commands::maps::get_map_nav_cmd,
            commands::maps::create_map_nav_cmd,
            commands::maps::save_map_nav_cmd,
